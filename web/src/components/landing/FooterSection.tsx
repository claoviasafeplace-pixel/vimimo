      ...
      <section className="relative py-32 px-6 border-t border-border/50 overflow-hidden">
        ...
        >
          ...
          <p className="mt-5 text-lg text-muted">
            Commandez votre premier staging premium et recevez vos visuels sous 24h.
          ...
          <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            <div className="lg:col-span-1">
              ...
              <p className="text-sm leading-relaxed text-muted max-w-xs">
                Staging virtuel premium avec validation expert
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/pricing" className="text-sm text-muted transition-colors hover:text-foreground">Tarifs</Link></li>
              </ul>
            </div>
